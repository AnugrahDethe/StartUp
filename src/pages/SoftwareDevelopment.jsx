...
import {
  ...
  Code2, Cloud, Rocket, Sparkles, Database, Settings
} from 'lucide-react';

const stats = [
  { target: 0, suffix: '+', label: 'Enterprise Systems' },
  { target: 0, suffix: '%', label: 'Cost Reduction' },
  { target: 0, suffix: 'x', label: 'ROI Average' },
  { target: 24, suffix: '/7', label: 'Support Uptime' },
];
  ...
  return (
    <motion.div variants={fadeUpVariant} ref={ref} className="text-center px-4">
      <motion.div
        ...
        className="text-4xl lg:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400 mb-2"
      >
        {value}{suffix}
      </motion.div>
...
const whyChooseUs = [
  {
    ...
    desc: 'Future-proof architectures using Docker and Kubernetes that scale automatically with your business growth.',
    icon: Database,
    accent: '#10B981'
  },
  {
    title: 'Legacy Modernisation',
    desc: 'Seamlessly upgrade outdated monolithic systems to modern tech stacks without losing historical data or uptime.',
    icon: Settings,
    accent: '#06B6D4'
  },
  {
    title: 'Deep Integrations',
    desc: 'Custom APIs and middleware that connect your isolated tools into a single, unified workflow.',
    icon: Layers,
    accent: '#3B82F6'
  },
  {
    title: 'Enterprise Security',
    desc: 'End-to-end encryption, regular penetration testing, and compliance with GDPR, HIPAA, and ISO standards.',
    icon: Shield,
    accent: '#8B5CF6'
  }
];
...
const process = [
  {
    ...
    desc: 'Identifying bottlenecks and defining requirements.',
    icon: Search
  },
  {
    step: '02',
    title: 'System Architecture',
    desc: 'Designing database schemas and API layers.',
    icon: Server
  },
  {
    step: '03',
    title: 'Agile Development',
    desc: 'Iterative two-week sprints with transparent demos.',
    icon: Code2
  },
  {
    step: '04',
    title: 'Enterprise Deployment',
    desc: 'Zero-downtime migrations and staff training.',
    icon: Rocket
  }
];
...
const SoftwareDevelopment = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen text-gray-200 overflow-x-hidden selection:bg-emerald-500/30">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <motion.div
          ...
          className="absolute -top-1/2 -right-1/4 w-[1000px] h-[1000px] bg-emerald-500/5 rounded-full blur-[150px]"
        />
        <motion.div
          animate={{ rotate: -360, scale: [1, 1.1, 1] }}
          transition={{ duration: 35, repeat: Infinity, ease: "linear" }}
          className="absolute top-1/4 -left-1/4 w-[800px] h-[800px] bg-teal-500/5 rounded-full blur-[120px]"
        />
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto px-6 md:px-12">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <motion.div variants={staggerContainer} initial="hidden" animate="visible">
                <motion.div variants={fadeUpVariant} className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-emerald-500/20 bg-emerald-500/5 mb-8">
                  <div className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                  <span className="text-xs font-semibold text-emerald-300 tracking-wider uppercase">Enterprise IT</span>
                </motion.div>

                <motion.h1 variants={fadeUpVariant} className="text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] mb-6">
                  Custom Software <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400">Development</span>
                </motion.h1>

                <motion.p variants={fadeUpVariant} className="text-gray-400 text-lg md:text-xl leading-relaxed mb-10 max-w-xl">
                  Bespoke enterprise software solutions engineered to automate complex workflows and modernize legacy infrastructure.
                </motion.p>
                ...
                <motion.div variants={fadeUpVariant} className="flex flex-wrap items-center gap-4">
                  <a
                    href="#contact"
                    onClick={onBack}
                    className="relative group overflow-hidden px-8 py-3.5 rounded-full font-semibold text-white bg-white/5 border border-white/10 hover:border-emerald-500/50 transition-all duration-300"
                  >
        ...
        <section ref={refOverview} className="py-24 lg:py-32 relative">
          <div className="container mx-auto px-6 md:px-12">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <div className="absolute inset-0 bg-emerald-500/20 blur-[100px] rounded-full pointer-events-none group-hover:bg-emerald-500/30 transition-colors duration-700" />
                <motion.div
                  style={{ y: yParallax }}
                  className="relative rounded-3xl overflow-hidden glass border border-white/10 p-2 shadow-2xl"
                >
                  <div className="absolute inset-0 bg-emerald-500/10 mix-blend-overlay group-hover:opacity-0 transition-opacity duration-500" />
                  <img
              ...
              <motion.div variants={staggerContainer} initial="hidden" animate={inViewOverview ? "visible" : "hidden"} className="order-1 lg:order-2">
                <motion.div variants={fadeUpVariant} className="inline-flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-emerald-400 font-semibold tracking-wider text-sm uppercase">Service Overview</h3>
                </motion.div>

                <motion.h2 variants={fadeUpVariant} className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">
                  Software That Transforms Operations
                </motion.h2>

                <div className="space-y-6 text-gray-400 leading-relaxed text-lg">
                  <motion.p variants={fadeUpVariant}>
                    Off-the-shelf software often forces you to adapt your business processes to its limitations. We build custom software that adapts perfectly to how your business actually works.
                  </motion.p>
                  <motion.p variants={fadeUpVariant}>
                    Our engineering teams specialize in complex system architecture, legacy modernization, and high-performance backend development using Node.js, Python, Java, and Go.
                  </motion.p>
                  <motion.p variants={fadeUpVariant}>
                    From internal management dashboards and supply chain logistics tools to fully automated data processing pipelines, we deliver software that significantly reduces operational costs and manual labor.
                  </motion.p>
                </div>
              </motion.div>
        ...
        <section className="py-24 bg-white/[0.02] border-t border-white/5 relative backdrop-blur-sm">
          <div className="container mx-auto px-6 md:px-12">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={staggerContainer} className="mb-16">
              <motion.h3 variants={fadeUpVariant} className="text-emerald-400 font-semibold tracking-wider text-sm uppercase mb-4">Why Choose Us</motion.h3>
              <div className="grid lg:grid-cols-2 gap-8 items-end">
                ...
                <motion.p variants={fadeUpVariant} className="text-gray-400 text-lg pb-2">
                  We write clean, documented, and test-driven code that can be easily maintained and scaled by any engineering team.
                </motion.p>
              </div>
            </motion.div>
        ...
        <section ref={refMethodology} className="py-24 lg:py-32 relative overflow-hidden">
          <div className="container mx-auto px-6 md:px-12">
            <motion.div initial="hidden" animate={inViewMethodology ? "visible" : "hidden"} variants={staggerContainer} className="text-center max-w-3xl mx-auto mb-20">
              ...
              <motion.h2 variants={fadeUpVariant} className="text-4xl md:text-5xl font-bold mb-6">How We Build Systems</motion.h2>
              <motion.p variants={fadeUpVariant} className="text-gray-400 text-lg">A strict engineering protocol that prioritizes stability, security, and speed.</motion.p>
            </motion.div>

            <div className="relative max-w-5xl mx-auto">
              <div className="hidden md:block absolute top-12 left-0 right-0 h-px bg-white/10" />
              <motion.div
                className="hidden md:block absolute top-12 left-0 h-px bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-500"
                initial={{ width: 0 }}
                ...
                {process.map((step, idx) => {
                  ...
                  return (
                    <motion.div key={idx} initial={{ opacity: 0, y: 50, scale: 0.9 }} animate={inViewMethodology ? { opacity: 1, y: 0, scale: 1 } : {}} transition={{ delay: 0.5 + (idx * 0.2), type: "spring", stiffness: 100, damping: 12 }} className="flex flex-col items-center text-center group">
                      <motion.div whileHover={{ scale: 1.1, rotate: 5 }} className="w-24 h-24 rounded-full glass border-2 border-white/10 flex items-center justify-center bg-black/50 mb-6 relative group-hover:border-emerald-500/50 transition-colors shadow-xl">
                        <span className="text-2xl font-bold text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-emerald-400 group-hover:to-teal-400 transition-all">{step.step}</span>
                        <motion.div initial={{ scale: 0 }} animate={inViewMethodology ? { scale: 1 } : { scale: 0 }} transition={{ delay: 1 + (idx * 0.2), type: "spring", bounce: 0.5 }} className="absolute -bottom-2 -right-2 w-10 h-10 rounded-full bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center text-white border-4 border-[#030305] group-hover:animate-pulse">
                          <Icon size={18} />
                        </motion.div>
                      </motion.div>
                      <h4 className="text-xl font-bold text-white mb-3 group-hover:text-emerald-300 transition-colors">{step.title}</h4>
        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <motion.div animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0.5, 0.3] }} transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }} className="absolute -bottom-1/2 -left-1/4 w-full aspect-square bg-emerald-900/40 rounded-full blur-[120px] pointer-events-none" />
          <motion.div animate={{ scale: [1, 1.3, 1], opacity: [0.3, 0.6, 0.3] }} transition={{ duration: 12, repeat: Infinity, ease: "easeInOut", delay: 2 }} className="absolute -top-1/2 -right-1/4 w-full aspect-square bg-teal-900/30 rounded-full blur-[120px] pointer-events-none" />
          ...
          <div className="container mx-auto px-6 md:px-12 relative z-10">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="max-w-4xl mx-auto text-center">
              <motion.h3 variants={fadeUpVariant} className="text-emerald-400 font-semibold tracking-wider text-sm uppercase mb-4">Upgrade Your Infrastructure</motion.h3>
              <motion.h2 variants={fadeUpVariant} className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight">Let's Build Software <br className="hidden md:block" /> That Scales With You</motion.h2>
              <motion.p variants={fadeUpVariant} className="text-gray-300 text-lg md:text-xl leading-relaxed mb-12 max-w-2xl mx-auto">Partner with StartUp to transform your Ideas into Reality. Our engineers are ready to audit your current systems.</motion.p>
